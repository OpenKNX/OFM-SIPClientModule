...
SIPChannelOwnerModule::SIPChannelOwnerModule(uint8_t numberOfChannels)
...
SIPChannelOwnerModule::~SIPChannelOwnerModule()
{
...
/*
    ...
    */
void SIPChannelOwnerModule::setup(bool configured)
{
    OpenKNX::Module::setup(configured);
}

OpenKNX::Channel* SIPChannelOwnerModule::createChannel(uint8_t _channelIndex /* this parameter is used in macros, do not rename */)
{
    return nullptr;
}

void SIPChannelOwnerModule::setup()
{
...
/*
    ...
    */
void SIPChannelOwnerModule::loop(bool configured)
{
...
OpenKNX::Channel* SIPChannelOwnerModule::getChannel(uint8_t channelIndex)
{
    return _pChannels != nullptr ? _pChannels[channelIndex] : nullptr;
}

uint8_t SIPChannelOwnerModule::getNumberOfChannels()
{
    return _numberOfChannels;
}

uint8_t SIPChannelOwnerModule::getNumberOfUsedChannels()
{
...
void SIPChannelOwnerModule::loop()
{
    OpenKNX::Module::loop();
    if (_pChannels != nullptr)
    {
...
/*
    ...
    */
void SIPChannelOwnerModule::SIPChannelOwnerModule::setup1(bool configured)
{
...
void SIPChannelOwnerModule::SIPChannelOwnerModule::setup1()
{
...
/*
    ...
    */
void SIPChannelOwnerModule::loop1(bool configured)
{
...
void SIPChannelOwnerModule::loop1()
{
...
/*
    ...
    * @param GroupObject
    */
void SIPChannelOwnerModule::processInputKo(GroupObject &ko)
{
